...
CREATE TABLE `ums_member`(
    ...
    `identity_status`                   tinyint(2) DEFAULT 0 COMMENT '身份状态(1:职场人 2:学生)',
    `work_status`                       tinyint(2) DEFAULT 0 COMMENT '求职状态(1:离职-随时到岗 2:在职-月内到岗 3:在职-考虑机会 4:在职-暂不考虑)',
    `highest_qualification`             tinyint(2) DEFAULT 0 COMMENT '最高学历(1:初中及以下 2:中专/中技 3:高中 4:大专 5:本科 6-硕士 7-博士)',
    `highest_qualification_type`        tinyint(2) DEFAULT 0 COMMENT '最高学历类型(1:全日制 2:非全日制)',
