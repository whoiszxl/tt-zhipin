package com.whoiszxl.zhipin.tools.map.test;
...
import com.whoiszxl.zhipin.tools.map.session.MapSessionFactory;
import com.whoiszxl.zhipin.tools.map.session.impl.DefaultMapSessionFactory;
import com.whoiszxl.zhipin.tools.map.test.api.MyOssUploadApi;
