...
public class SendTest {
    ...
    public void heartBeat() throws IOException, InterruptedException, JSONException {
        ...
        byte[] commandType = ByteBuffer.allocate(1).put(Command.Login).array();
        byte[] clientType = ByteBuffer.allocate(1).put((byte) 2).array();
        byte[] messageType = ByteBuffer.allocate(1).put((byte)1).array();

        JSONObject data = new JSONObject();
        data.put(FieldConstants.TOKEN, "2f46df14-54b2-4e4d-a9b0-1cc472f55988");
        ...
        commandType = ByteBuffer.allocate(1).put(Command.HEART_BEAT).array();
    ...
    public void loginAndLogout() throws IOException, JSONException, InterruptedException {
        ...
        byte[] token = "2f46df14-54b2-4e4d-a9b0-1cc472f55988".getBytes();
