package com.whoiszxl.zhipin.im.generator;
...
public class MyBatisFastAutoGenerator {
    ...
    private static final String PACKAGE_NAME = "com.whoiszxl.zhipin.im";

    /**
     * 指定代码生成到哪个项目下
     */
    private static final String PROJECT_NAME = "tt-zhipin-im/tt-zhipin-im-web";
