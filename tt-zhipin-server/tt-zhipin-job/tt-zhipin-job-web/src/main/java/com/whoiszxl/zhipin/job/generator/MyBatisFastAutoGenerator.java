package com.whoiszxl.zhipin.job.generator;
...
public class MyBatisFastAutoGenerator {
    ...
    private static final String PACKAGE_NAME = "com.whoiszxl.zhipin.job";

    /**
     * 指定代码生成到哪个项目下
     */
    private static final String PROJECT_NAME = "tt-zhipin-job/tt-zhipin-job-web";
