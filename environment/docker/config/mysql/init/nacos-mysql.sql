...
/*   创建 nacos 数据库   */
/******************************************/
CREATE DATABASE IF NOT EXISTS nacos default charset = utf8mb4;
...
/******************************************/
CREATE USER 'tt-zhipin-nacos'@'%' IDENTIFIED BY 'tt-zhipin-nacos';
GRANT ALL PRIVILEGES ON `nacos`.* TO 'tt-zhipin-nacos'@'%' IDENTIFIED BY 'tt-zhipin-nacos';
FLUSH PRIVILEGES;