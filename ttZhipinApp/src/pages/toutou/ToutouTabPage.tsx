...
import MessagePage from "../worker/message/MessagePage";
import ToutouWorkerPage from "./toutou_worker/ToutouWorkerPage";
        ...
        <View style={styles.root}>
            ...
            <Tab.Navigator tabBar={(props) => <MyTabBar {...props} />}>
                ...
                <Tab.Screen name="ToutouSearchPage" component={ToutouSearchPage} options={{
                    title: '搜索', headerShown: false, lazy: false
                }}/>
                ...
                <Tab.Screen name="ToutouMinePage" component={ToutouMinePage} options={{
